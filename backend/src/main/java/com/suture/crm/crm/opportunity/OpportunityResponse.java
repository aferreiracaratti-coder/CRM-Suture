...
public record OpportunityResponse(UUID id, UUID ownerId, UUID companyId, UUID contactId, String name, String stage,
    ...
    static OpportunityResponse from(Opportunity opportunity) {
        return new OpportunityResponse(opportunity.getId(), opportunity.getOwnerId(), opportunity.getCompanyId(), opportunity.getContactId(),
