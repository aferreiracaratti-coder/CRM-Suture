...
public record CompanyResponse(UUID id, UUID ownerId, String name, String website, String address, String phone, String whatsapp, String email,
                              String industry, String city, String country, String source, String status) {
    static CompanyResponse from(Company company) {
        return new CompanyResponse(company.getId(), company.getOwnerId(), company.getName(), company.getWebsite(), company.getAddress(), company.getPhone(),
